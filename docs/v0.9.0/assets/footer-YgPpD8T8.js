import{B as o,d as c}from"./_base-Cy1ntaVh.js";const h=`
    <template id="footer">
		<div class="mx-auto max-w-7xl px-6 pt-20 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
			<div class="flex flex-wrap w-full justify-center gap-8 pb-12">
				...
				<div class="w-max md:w-1/4 ms-8">
					<h3 class="text-sm font-bold text-white" aria-describedby="newsletter-description" >Newsletter</h3>
...
`;class m extends o{static get observedAttributes(){return["copyright","company"]}constructor(){super(),this._templateInjected=!1}connectedCallback(){this._injectTemplate(),this.render(),this._setupNewsletterForm()}attributeChangedCallback(e,t,i){t!==i&&this.isConnected&&this._updateCopyright()}_injectTemplate(){if(document.getElementById("footer-template-styles"))return;const e=document.createElement("style");e.id="footer-template-styles",e.textContent=`
			content-info { display: block }
			content-details { display: block }
		`,document.head.appendChild(e)}_setupNewsletterForm(){this.querySelector("form")?.addEventListener("submit",e=>{e.preventDefault();const t=this.querySelector('[type="email"]')?.value;t&&this.emit("newsletter-submit",{email:t})})}_updateCopyright(){const e=this.querySelector("[data-copyright]");e&&(e.textContent=this._getCopyrightText())}_getCopyrightText(){const e=this.getAttribute("copyright")||new Date().getFullYear(),t=this.getAttribute("company")||"Legacy Concierge";return`© ${e} ${t}`}render(){this.querySelector("[slot]")?this._renderWithSlots():this._renderDefaultTemplate()}_renderWithSlots(){const e=this.h("div",{class:"ui-footer-container"}),t=this.h("footer",{class:"bg-secondary",role:"contentinfo"},this.h("div",{class:["mx-auto","w-[80dvw]","max-w-[120rem]","px-6","pt-20","pb-8","sm:pt-24","lg:px-8","lg:pt-32"].join(" ")},this.h("div",{class:["xl:grid","xl:grid-cols-3","xl:gap-8"].join(" ")},this.h("slot",{name:"links"}),this.h("slot",{name:"newsletter"})),this.h("div",{class:["mt-16","border-t","border-white/10","pt-8","sm:mt-20","md:flex","md:items-center","md:justify-between","lg:mt-24"].join(" ")},this.h("div",{class:["flex","gap-x-6","md:order-2"].join(" ")},this.h("slot",{name:"social"})),this.h("p",{class:["mt-8","text-sm/6","text-muted","md:order-1","md:mt-0"].join(" "),"data-copyright":""},this._getCopyrightText()))));e.appendChild(t);const i=Array.from(this.children);this.innerHTML="",this.appendChild(e);for(const s of i)this.appendChild(s)}_renderDefaultTemplate(){const e=document.createElement("div");e.innerHTML=h;const t=e.querySelector("template");if(t){const i=t.content.cloneNode(!0),s=i.querySelector("footer > div > div:last-child > p");s&&(s.textContent=this._getCopyrightText(),s.setAttribute("data-copyright","")),this.innerHTML="",this.appendChild(i)}}}class x extends o{static get observedAttributes(){return["heading"]}connectedCallback(){this.render()}attributeChangedCallback(e,t,i){t!==i&&this.isConnected&&this.render()}render(){const e=this.getAttribute("heading")||"",t=Array.from(this.querySelectorAll("a")),i=this.h("div",{},this.h("h3",{class:[""].join(" ")},e),this.h("ul",{role:"list",class:"mt-6 space-y-4"},...t.map(l=>{const r=this.h("li",{}),n=l.cloneNode(!0);return n.className=["text-sm/6","text-muted","",""].join(" "),r.appendChild(n),r}))),s=t.map(l=>l.cloneNode(!0));this.innerHTML="",this.appendChild(i);const a=this.h("div",{hidden:!0});for(const l of s)a.appendChild(l);this.appendChild(a)}}c("global-footer",m);c("content-info",x);export{x as ContentInfo,h as FOOTER_TEMPLATE,m as GlobalFooter,x as default};
//# sourceMappingURL=footer-YgPpD8T8.js.map
