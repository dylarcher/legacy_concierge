import{d as a,r as C}from"./image-manifest-BCoBbZbv.js";import{B as E,d as A}from"./_base-CHH91Cyl.js";const h="/legacy_concierge/v0.5.0/assets/bg-crashing-waves-fullscreen-video-p683KzGq.mp4",m="/legacy_concierge/v0.5.0/assets/bg-crashing-waves-fullscreen-video-BGHukiE1.webm",p=!1,B=!p,S=()=>`
    <template id="banner">
...
`;class j extends E{static get observedAttributes(){return["heading","description","image","image-alt","video","video-type","no-video","primary-cta","primary-href","secondary-cta","secondary-href","align"]}connectedCallback(){this._injectStyles(),this.render()}attributeChangedCallback(e,r,i){r!==i&&this.isConnected&&this.render()}_injectStyles(){if(document.getElementById("banner-template-styles"))return;const e=document.createElement("style");e.id="banner-template-styles",e.textContent=`
			hero-banner {
				display: block;
			}
